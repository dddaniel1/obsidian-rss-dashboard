...
- Fixed FreshRSS folders missing from the Add feed folder selector when the server omits the optional folder type field from its Google Reader API response or lists categories only in the subscription list.
