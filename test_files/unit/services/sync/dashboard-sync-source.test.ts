...
function setup() {
  ...
  state.subscriptions = [{ id: "feed/1", title: "Remote", url: "https://same.example/rss", folder: state.folders[0].id }];
  state.articles["1"] = { id: "1", feedId: "feed/1", title: "Remote article", content: "body", link: "", published: 1, read: false, starred: false, author: "" };
